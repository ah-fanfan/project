...
@WebServlet("/TestByNormalServlet")
public class TestByNormalServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String key = request.getParameter("t_normal");
		...
		try {
			testPage = testService.getPageBeanByNormal(pageNumber, pageSize, key);
