...
@WebServlet("/CarBySelectServlet")
public class CarBySelectServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			request.getRequestDispatcher("/beanclass/user/carQuery.jsp").forward(request, response);
