				...
				<div id="page-content">
					<div class="block">
						<div class="block-title clearfix">
							<h2>
								<span class="hidden-xs">用户信息回显</span>
							</h2>
						</div>
						<form action="UserUpdateServlet" method="post"
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="hidden" name="id" class="form-control"
										value=${user.id } autocomplete="off"> <span
								...
								<div class="col-md-4">
									<input type="text" name="user_name" class="form-control"
										value="${user.user_name }"> <span class="help-block"></span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="text" name="user_age" class="form-control"
										value="${user.user_age }"> <span class="help-block"></span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="text" name="user_psw" class="form-control"
										value="${user.user_psw }"> <span
										class="help-block"></span>
								</div>
							...
							<label class="col-md-2 control-label" for="example-chosen">
								...
								<div class="col-md-4">
									<input type="text" name="user_idcard" class="form-control"
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="text" name="comment" class="form-control"
										value="${user.comment }"> <span class="help-block"></span>
								</div>
								<label class="col-md-2 control-label" for="example-hf-password">
								...
								<div class="col-md-4">
									<select id="state" name="state" class="select-select2"
										...
										<c:if test="${user.state==1 }">
											<option value="1" selected="selected"> 1--有效用户</option>
											<option value="0">0--已注销用户</option>
										</c:if>
										<c:if test="${user.state==0 }">
											<option value="1"> 1--有效用户</option>
											<option value="0" selected="selected">0--已注销用户</option>
										</c:if>
									</select>
								</div>
							</div>
