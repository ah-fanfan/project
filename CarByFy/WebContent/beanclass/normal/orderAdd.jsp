			...
			<div id="main-container">
				...
				<div id="page-content">
					<div class="block">
						...
						<form action="OrderAddServlet?id=管理员" method="post"
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<select name='user_idcard' class="select-select2"
										style="width: 100%;"></select> <span class="help-block"></span>
								</div>
								<label class="col-md-2 control-label" for="example-chosen">
				...
				<script type="text/javascript">
					...
					function initIdCard(code) {
	// ajax请求所有省份
	$.get("mark_and_kind", {
		method : "initPhone",
		Code:     code
	}, function(data) {
		$("select[name='user_idcard']").empty();
		$.each(data, function(i, d) {
			$("select[name='user_idcard']").append(
					"<option value='"+d.user_idcard+"'>"
							+ d.user_idcard + "</option>");
			/* 这里的d.code和d.name是要必需对应province类code和name字段 */
		});
