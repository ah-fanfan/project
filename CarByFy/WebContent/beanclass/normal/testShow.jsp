				...
				<div id="page-content">
					<div class="block">
						<div class="block-title clearfix">
							<h2>
								<span class="hidden-xs">试驾信息回显</span>
							</h2>
						</div>
						<form action="TestUpdateServlet" method="post"
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="hidden" name="id" class="form-control"
										value=${test.t_id }> <span
										class="help-block"> 
										<input type="text" name="idd"
										class="form-control" placeholder=${ test.t_id}> <span
								...
								<div class="col-md-4">
									<input type="text" name="t_code" class="form-control"
										value=${test.t_code }> <span class="help-block"></span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="text" name="user_name" class="form-control"
										value="${test.user_name }"> <span class="help-block"></span>
								</div>
								<label class="col-md-2 control-label" for="example-chosen">
								...
								<div class="col-md-4">
									<input type="text" name="user_phone" class="form-control"
										value="${test.user_phone }"> <span class="help-block"></span>
								</div>
							...
							<div class="form-group">
								<label class="col-md-2 control-label" for="example-hf-password">
									试驾车型<span class="text-danger">*</span>
								</label>
								<div class="col-md-4">
									<select name='t_car' class="select-select2"
										style="width: 100%;">
										<option  value="${test.t_car }" selected="selected">${test.t_car }</option>
										</select>
								</div>
								<label class="col-md-2 control-label" for="example-hf-password">
								...
								<div class="col-md-4">
									<select name='t_shop' class="select-select2"
										style="width: 100%;">
										<option  value="${test.t_shop}" selected="selected">${test.t_shop }</option>
										</select>
								</div>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<select name='t_normal' class="select-select2"
										style="width: 100%;">
										<option  value="${test.t_normal }" selected="selected">${test.t_normal }</option>
										</select>
								</div>
								<label class="col-md-2 control-label" for="example-hf-password">
									试驾时间<span class="text-danger">*</span>
								</label>
								<div class="col-md-4">
									<input type="text" name="t_date" class="form-control"
										value="${test.t_date }"> <span class="help-block"></span>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="text" name="comment" class="form-control"
										value="${test.comment }"> <span class="help-block"></span>
								</div>
								<label class="col-md-2 control-label" for="example-hf-password">
								...
								<div class="col-md-4">
									<select id="state" name="state" class="select-select2"
										...
										<c:if test="${test.state==1 }">
											<option value="1" selected="selected"> 1--有效试驾信息</option>
											<option value="0">0--无效试驾信息</option>
										</c:if>
										<c:if test="${tets.state==0 }">
											<option value="1"> 1--有效试驾信息</option>
											<option value="0" selected="selected">0--无效试驾信息</option>
										</c:if>
									</select>
								</div>
							</div>
