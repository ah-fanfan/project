			...
			<div id="main-container">
				...
				<div id="page-content">
					<div class="block">
						...
						<form action="OrderQueryServlet?id=管理员" id="studentForm" method="post">
								...
								<div class="input-group">
									<span class="input-group-btn">
										<button type="button" class="btn btn-success"
											...
											onclick=
											"window.location='${pageContext.request.contextPath}/beanclass/normal/orderAdd.jsp'">
 ...
 function shangyiye(){
	...
	if(page==1){
		...
		return;
		 ...
		 window.location.href="./OrderQueryServlet?id=管理员&&pageNumber="+${orderPage.pageNumber-1}+"&&pageSize=6";
	}
 }
 function xiayiye(){
		var totalPage = ${orderPage.totalPage};
 ...
 function shouye(){
		...
		if(page== 1){
			...
			return;
			 ...
			 window.location.href="./OrderQueryServlet?id=管理员&&pageNumber=1&&pageSize=6";
		}
	 }
 function weiye(){
		var totalPage = ${orderPage.totalPage};
		...
		if(page== totalPage){
			...
			return;
			 ...
			 window.location.href="./OrderQueryServlet?id=管理员&&pageNumber="+totalPage+"&&pageSize=6";
		}
	 }
</script>
</body>
