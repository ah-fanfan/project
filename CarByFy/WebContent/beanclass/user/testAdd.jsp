			...
			<div id="main-container">
				...
				<div id="page-content">
					<div class="block">
						...
						<form action="TestAddServlet?id=用户" method="post" 
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="text" name="user_name" class="form-control"  value="${user.user_name }" readonly="readonly">
									<span class="help-block"></span>
								</div>
							</div>
							...
							<label class="col-md-2 control-label" for="example-chosen">
								...
								<div class="col-md-4">
									<input type="text" name="user_phone" class="form-control" value="${user.user_phone }" readonly="readonly">
									<span class="help-block"></span>
								</div>
							...
							<div class="form-group">
								...
								<label class="col-md-2 control-label" for="example-chosen">
									试驾专员<span class="text-danger">*</span>
								</label>
								<div class="col-md-4">
