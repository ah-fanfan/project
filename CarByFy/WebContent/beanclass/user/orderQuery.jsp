...
<body>
								...
								<div class="input-group">
									<span class="input-group-btn">
										<button type="button" class="btn btn-success"
											...
											onclick=
											"window.location='${pageContext.request.contextPath}/beanclass/user/orderAdd.jsp'">
 ...
 function OrderDelete(id){
	 if(confirm("确认删除吗") ==true){
         window.location.href="./OrderDelServlet?id="+id+",用户";
         var d = dialog({
 			title : '系统提示',
 			content : "删除成功！！！"
 		});
 ...
 function shangyiye(){
	...
	if(page==1){
		...
		return;
		 ...
		 window.location.href="./OrderByIdCardServlet?pageNumber="+${orderPage.pageNumber-1}+"&&pageSize=6";
	}
 }
 function xiayiye(){
		var totalPage = ${orderPage.totalPage};
 ...
 function shouye(){
		...
		if(page== 1){
			...
			return;
			 ...
			 window.location.href="./OrderByIdCardServlet?pageNumber=1&&pageSize=6";
		}
	 }
 function weiye(){
		var totalPage = ${orderPage.totalPage};
		...
		if(page== totalPage){
			...
			return;
			 ...
			 window.location.href="./OrderByIdCardServlet?pageNumber="+totalPage+"&&pageSize=6";
		}
	 }
</script>
</body>
