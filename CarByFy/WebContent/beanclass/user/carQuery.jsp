			...
			<div id="main-container">
				...
				<div id="page-content">
					<div class="block">
						...
						<form action="CarBySelectServlet" id="studentForm" method="post">
							<div class="block-title" style="padding: 7px">
								<div class="input-group">
									<span class="input-group-btn">
										<button type="button" class="btn btn-success"
											style="margin-right: 5px" id="btn_newaccount"
											onclick="window.location='${pageContext.request.contextPath}/beanclass/user/orderAdd.jsp'">
											<i class="fa fa-plus"></i> 在线下单
										</button>
								...
								<tbody>
									<c:forEach items="${carPage.list}" var="car">
										<tr>
											...
											<a href="CarByIdServlet?id=${car.id},详情"
												class="btn btn-primary "> <i class="fa fa-cog"></i>详情了解
											</a>
                                            </td>
										</tr>
									</c:forEach>
 ...
 function shangyiye(){
	...
	if(page==1){
		...
		return;
		 ...
		 window.location.href="./CarBySelectServlet?pageNumber="+${carPage.pageNumber-1}+"&&pageSize=6";
	}
 }
 function xiayiye(){
		var totalPage = ${carPage.totalPage};
 ...
 function shouye(){
		...
		if(page== 1){
			...
			return;
			 ...
			 window.location.href="./CarBySelectServlet?pageNumber=1&&pageSize=6";
		}
	 }
 function weiye(){
		var totalPage = ${carPage.totalPage};
		...
		if(page== totalPage){
			...
			return;
			 ...
			 window.location.href="./CarBySelectServlet?pageNumber="+totalPage+"&&pageSize=6";
		}
	 }
</script>
</body>
