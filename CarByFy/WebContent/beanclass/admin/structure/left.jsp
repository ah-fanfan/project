			...
			<ul class="sidebar-nav">
				...
				<li><a href="#" class="sidebar-nav-menu"> <i
					...
					<ul>
						...
						<li><a href="ShopQueryServlet">车店信息查询</a></li>
						<li><a href="ShopQueryServlet">车店信息修改</a></li>
						<li><a href="ShopQueryServlet">删除车店信息</a></li>
					</ul></li>
				...
				<li><a href="#" class="sidebar-nav-menu"> <i
					...
					<ul>
						<li><a
							href="<%=basePath%>beanclass/normal_admin/normalAdd.jsp">管理员入职</a>
						</li>
						<li><a href="NormalQueryServlet">管理员信息查询</a></li>
						<li><a href="NormalQueryServlet">管理员信息修改</a></li>
						<li><a href="NormalQueryServlet">管理员离职</a></li>
					</ul></li>
				...
				<ul>
					<li><a href="<%=basePath%>beanclass/car/carAdd.jsp">车辆入库</a></li>
					<li><a href="CarQueryServlet">车辆信息查询</a></li>
					<li><a href="CarQueryServlet">车辆信息修改</a></li>
					<li><a href="CarQueryServlet">车辆出库</a></li>
				</ul>
				</li>
				...
				<ul>
					<li><a href="OrderQueryServlet?id=超级管理员">订单信息查询</a></li>
				</ul>
				</li>
				...
				<ul>
					<li><a href="CarCountServlet?id=超级管理员">车型销量排行</a>
					</li>
