		...
		<div class="sidebar-content">
			...
			<ul class="sidebar-nav">
				...
				<li><a href="#" class="sidebar-nav-menu"> <i
					...
					<ul>
						<li><a href="<%=basePath%>views/account/account_add.jsp">管理员入职</a>
						</li>
				...
				<ul>
					<li><a href="<%=basePath%>beanclass/car/carAdd.jsp">在售车辆查询</a>
					</li>
					<li><a href="CarQueryServlet">车辆入库</a>
					</li>
					<li><a href="CarQueryServlet">在售车辆信息修改</a>
					</li>
				...
				<ul>
					<li><a href="<%=basePath%>views/modeldialog/model_dialog.jsp">订单信息查询</a>
					</li>
					<li><a href="<%=basePath%>views/modeldialog/model_dialog.jsp">新增订单</a>
					</li>
					<li><a href="<%=basePath%>views/modeldialog/model_dialog.jsp">订单信息修改</a>
					</li>
					<li><a href="<%=basePath%>views/modeldialog/model_dialog.jsp">订单信息删除</a>
					</li>
				</ul>
				</li>
