				...
				<div id="page-content">
					<div class="block">
						<div class="block-title clearfix">
							<h2>
								<span class="hidden-xs">职员信息回显</span>
							</h2>
						</div>
						<form action="NormalUpdateServlet" method="post"
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="hidden" name="id" class="form-control"
										value=${normal.id } autocomplete="off"> <span
										class="help-block"> <input type="text" name="idd"
										class="form-control" placeholder=${normal.id }> <span
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="text" name="ad_code" class="form-control"
										value=${normal.ad_code }> <span
										class="help-block"></span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="text" name="ad_psw" class="form-control"
										value=${normal.ad_psw }> <span
										class="help-block"></span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<c:if test="${normal.ad_sex=='男' }">
										<input type="radio" name="ad_sex" value="男" checked="checked">男&nbsp;&nbsp;&nbsp;
									<input type="radio" name="ad_sex" value="女">女
									</c:if>
									<c:if test="${normal.ad_sex=='女' }">
										<input type="radio" name="ad_sex" value="男">男&nbsp;&nbsp;&nbsp;
									<input type="radio" name="ad_sex" value="女" checked="checked">女
									</c:if>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="text" name="ad_age" class="form-control"
										value="${normal.ad_age }"> <span
										class="help-block"></span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-4" name="ad_address">
									<select name='province' class="select-select2" style="width: 30%;"  >
									</select> <select name='city' class="select-select2" style="width: 30%;">
										
									</select> <select name='area' class="select-select2" style="width: 30%;">
                          ...
                          <div class="form-group">
								...
								<div class="col-md-4">
									<img style="height: 240px; width: 240px; " src="beanclass${normal.img} "    id="img_1" />
							...
							<div class="col-md-4">
									<select id="state" name="state" class="select-select2"
										...
										<c:if test="${normal.state==1 }">
											<option value="1" selected="selected"> 1--在职员工</option>
											<option value="0">0--离职员工</option>
										</c:if>
										<c:if test="${normal.state==0 }">
											<option value="1"> 1--在职员工</option>
											<option value="0" selected="selected">0--离职员工</option>
										</c:if> 
									</select>
								</div>
							</div>
