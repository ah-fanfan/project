			...
			<div id="main-container">
				...
				<div id="page-content">
					<div class="block">
						...
						<form action="NormalAddServlet" method="post" 
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="text" name="ad_psw" class="form-control" value="<%=RodomNumber.getStaffPsw()%>">
									<span class="help-block"></span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<select name="ad_age" class="select-select2"
										style="width: 100%;">
